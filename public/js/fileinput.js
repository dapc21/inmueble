...
(function ($) {
    ...
    var CAPTION_TEMPLATE = '<div class="form-control file-caption {class}">\n' +
        '   <span class="fa fa-file"></span> <span class="file-caption-name"></span>\n' +
        '</div>';
            ...
            for (var i = 0; i < total; i++) {
                (function (file) {
                    ...
                    if (preview.length > 0 && (fileType == "any" ? (isImg || isTxt) : (fileType == "text" ? isTxt : isImg)) && typeof FileReader !== "undefined") {
                        ...
                        preview.append("\n" + '<div class="file-preview-frame"><div class="file-preview-other"><h2><i class="fa fa-file"></i></h2>' + caption + '</div></div>');
                    }
                })(tfiles[i]);
            }
